...
/*
 * To Implement:
 * public static int height(Node root) - return height of tree (max length (typically # of edges) from root to leaf); recursive
 * public static int numLeaves(Node root) - returns # of leaves; recursive
 * public static void rangeSearch(Node root, int low, int high) - prints all #s that fall in range, inclusive, not necessarily in order or recursive
 */
public class LinkedTree {
    // An inner class for the nodes in the tree
    private class Node {
        private int key;         // the key field
        private LLList data;     // list of data associated with this key
    ...
    /*
     * Recursively finds and returns height of tree.
     * Returns -1 if root is null.
     * Returns 0 if root has no children.
     */
    ...
    /*
     * Recursively finds and returns number of leaf nodes.
     * Returns 0 if root is null.
     * Returns 1 if root has no children.
     */
    ...
    /*
     * Prints all numbers that fall within range,
     * given by a minumum int low and a maximum int high, inclusive.
     */
    public static void rangeSearch(Node root, int low, int high) {
